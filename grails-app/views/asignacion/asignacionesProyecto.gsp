...
<div id="accordion" style="width:1030px">
    <g:each in="${datos}" var="dato" status="h">
        <fieldset class="ui-corner-all" style="border:1px solid #46A3CA">
            ...
            <g:set var="programa" value="${mies.Proyecto.get(keyset.getAt(0)?.split('!')?.getAt(0)).programaPresupuestario}"></g:set>
            <g:set var="unidadEjec" value="${mies.Proyecto.get(keyset.getAt(0)?.split('!')?.getAt(0)).unidadEjecutora}"></g:set>
                            ...
                            <table style="width: 1000px;">
                                ...
                                <g:each in="${fuentes[keyset.getAt(0)?.split('!')?.getAt(0).toString()]}" var="fuente" status="m">
                                    ...
                                    %{--TODO cambiar para que valga con los valores de redistribucion--}%
                                        <g:set var="asgs" value='${mies.Asignacion.findAll("from Asignacion where marcoLogico = "+act.id+" and fuente= "+fuente.id)}'></g:set>
                                        ...
                                        <g:if test="${asg}">
                                            ...
                                            <td class="tipo"><g:select
                                                    from="${mies.TipoGasto.list([sort:'descripcion'])}"
                                        ...
                                        <g:else>
                                            <g:if test="${actual.estado==0}">
                                                <td class="anio">
                                                    %{--<g:select from="${mies.Anio.list([sort:'anio',order:'desc'])}" name="anio"--}%
                                                ...
                                                <td class="tipo">
                                                    <g:select from="${mies.TipoGasto.list([sort:'descripcion'])}"
                                                              name="tipoGasto" optionKey="id" optionValue="descripcion"/>
                                                </td>
                                                <td class="valor">
