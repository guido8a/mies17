...
<%@ page import="mies.EntidadesProyecto" %>
<html>
    <head>
                ...
                %{--</div>--}%
                    ...
                    <tr class="prop ${hasErrors(bean: entidadesProyectoInstance, field: 'entidad', 'error')}">
                        ...
                        <td class="campo" valign="middle">
                            <g:select class="field ui-widget-content ui-corner-all" name="entidad.id" title="${EntidadesProyecto.constraints.entidad.attributes.mensaje}" from="${mies.Entidad.list()}" optionKey="id" value="${entidadesProyectoInstance?.entidad?.id}" noSelection="['null': '']" />
                            %{----}%
                        </td>
                        ...
                        <td class="campo" valign="middle">
                            <g:select class="field ui-widget-content ui-corner-all" name="tipoParticipacion.id" title="${EntidadesProyecto.constraints.tipoParticipacion.attributes.mensaje}" from="${mies.TipoParticipacion.list()}" optionKey="id" value="${entidadesProyectoInstance?.tipoParticipacion?.id}" noSelection="['null': '']" />
                            %{----}%
                        </td>
                    ...
                    <tr class="prop ${hasErrors(bean: entidadesProyectoInstance, field: 'proyecto', 'error')}">
                        ...
                        <td class="campo" valign="middle">
                            <g:select class="field ui-widget-content ui-corner-all" name="proyecto.id" title="${EntidadesProyecto.constraints.proyecto.attributes.mensaje}" from="${mies.Proyecto.list()}" optionKey="id" value="${entidadesProyectoInstance?.proyecto?.id}" noSelection="['null': '']" />
                            %{----}%
                        </td>
