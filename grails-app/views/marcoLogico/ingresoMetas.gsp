...
<head>
    ...
    <title>Componente: ${actividad.marcoLogico.objeto}</title>
...
<div style="width: 1030px;min-height: 100px;float: left;margin-top: -20px">
    ...
    <div class="matriz ui-corner-all campo cmp  ">
        ...
        <div class="texto indicadores" style=" min-height: 40px;" id="indis">
            <g:each in="${mies.Indicador.findAllByMarcoLogico(actividad)}" var="indicador" status="i">
    ...
    <div class="matriz ui-corner-all campo cmp">
        ...
        <div class="texto supuestos" style=" min-height: 40px;" id="supuestos">
            <g:each in="${mies.Supuesto.findAllByMarcoLogico(actividad)}" var="su">
            ...
            <table>
                ...
                <tr class="prop">
                    ...
                    <td valign="top"
                        ...
                        <g:select class="field ui-widget-content ui-corner-all" name="anio.id"
                                  title="año" from="${mies.Anio.list([sort: 'anio'])}" optionKey="id"
                ...
                <tr class="prop">
                    ...
                    <td valign="top"
                        ...
                        <g:select class="field ui-widget-content ui-corner-all" name="tipoMeta.id"
                                  title="tipoMeta" from="${mies.TipoMeta.list()}" optionKey="id"
                ...
                <tr class="prop">
                    ...
                    <td valign="top"
                        ...
                        <g:select class="field ui-widget-content ui-corner-all" name="unidad.id"
                                  title="unidad"
                                  from="${mies.Unidad.list()}" optionKey="id"
                ...
                <tr class="prop">
                    ...
                    <td valign="top"
                        ...
                        %{--from="${mies.Parroquia.list()}" optionKey="id" value="${metaInstance?.parroquia?.id}"--}%
                        %{--noSelection="['null': '']"/>--}%
                    </td>
                </tr>
                ...
                <tr class="prop">
                    ...
                    <td valign="top"
                        class="value ${hasErrors(bean: metaInstance, field: 'inversion', 'errors')}">
                        <g:textField class="field number required ui-widget-content ui-corner-all"
                                     name="inversion"
                                     title="inversion" id="inversion_agr"
                                     value="${fieldValue(bean: metaInstance, field: 'inversion')}"/>
                    </td>
                </tr>
