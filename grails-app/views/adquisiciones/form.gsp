...
<%@ page import="mies.Adquisiciones" %>
<html>
    <head>
                ...
                %{--</div>--}%
                    ...
                    <tr class="prop ${hasErrors(bean: adquisicionesInstance, field: 'TipoAdquisicion', 'error')}">
                        ...
                        <td class="campo" valign="middle">
                            <g:select class="field ui-widget-content ui-corner-all" name="TipoAdquisicion.id" title="${Adquisiciones.constraints.tipoAdquisicion.attributes.mensaje}" from="${mies.TipoAdquisicion.list()}" optionKey="id" value="${adquisicionesInstance?.TipoAdquisicion?.id}" noSelection="['null': '']" />
                            %{----}%
                        </td>
                        ...
                        <td class="campo" valign="middle">
                            <g:select class="field ui-widget-content ui-corner-all" name="proyecto.id" title="${Adquisiciones.constraints.proyecto.attributes.mensaje}" from="${mies.Proyecto.list()}" optionKey="id" value="${adquisicionesInstance?.proyecto?.id}" noSelection="['null': '']" />
                            %{----}%
                        </td>
                    ...
                    <tr class="prop ${hasErrors(bean: adquisicionesInstance, field: 'tipoProcedencia', 'error')}">
                        ...
                        <td class="campo" valign="middle">
                            <g:select class="field ui-widget-content ui-corner-all" name="tipoProcedencia.id" title="${Adquisiciones.constraints.tipoProcedencia.attributes.mensaje}" from="${mies.TipoProcedencia.list()}" optionKey="id" value="${adquisicionesInstance?.tipoProcedencia?.id}" noSelection="['null': '']" />
                            %{----}%
                        </td>
