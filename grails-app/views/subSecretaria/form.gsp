...
<%@ page import="mies.SubSecretaria" %>
<html>
    <head>
                ...
                %{--</div>--}%
                    ...
                    <tr class="prop ${hasErrors(bean: subSecretariaInstance, field: 'entidad', 'error')}">
                        ...
                        <td class="campo" valign="middle">
                            <g:select class="field ui-widget-content ui-corner-all" name="entidad.id" title="${SubSecretaria.constraints.entidad.attributes.mensaje}" from="${mies.Entidad.list()}" optionKey="id" value="${subSecretariaInstance?.entidad?.id}" noSelection="['null': '']" />
                            %{----}%
                        </td>
