...
<%@ page import="mies.GrupoDeAtencion" %>
<html>
    <head>
                ...
                %{--</div>--}%
                    ...
                    <tr class="prop ${hasErrors(bean: grupoDeAtencionInstance, field: 'tipoGrupo', 'error')}">
                        ...
                        <td class="campo" valign="middle">
                            <g:select class="field ui-widget-content ui-corner-all" name="tipoGrupo.id" title="${GrupoDeAtencion.constraints.tipoGrupo.attributes.mensaje}" from="${mies.TipoGrupo.list()}" optionKey="id" value="${grupoDeAtencionInstance?.tipoGrupo?.id}" noSelection="['null': '']" />
                            %{----}%
                        </td>
                        ...
                        <td class="campo" valign="middle">
                            <g:select class="field ui-widget-content ui-corner-all" name="proyecto.id" title="${GrupoDeAtencion.constraints.proyecto.attributes.mensaje}" from="${mies.Proyecto.list()}" optionKey="id" value="${grupoDeAtencionInstance?.proyecto?.id}" noSelection="['null': '']" />
                            %{----}%
                        </td>
