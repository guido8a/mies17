<%--
  ...
  Time: 9:57
--%>
<%@ page import="mies.EntidadesProyecto; mies.TipoParticipacion" %>
<html>
<head>
...
<div class="dialog" title="${titulo} del proyecto ${proyecto}">
    ...
    <div style="margin-top: 10px;">
        ...
        %{--<g:form action="save${may}" class="frm${may}" method="post">--}%
            <g:form class="frmEntidades" method="post" action="saveEntidades">
                ...
                <table width="100%" class="ui-widget-content ui-corner-all">
                    ...
                    <tr class="prop ${hasErrors(bean: entidadesProyectoInstance, field: 'entidad', 'error')}">
                        ...
                        <td class="campo" valign="middle">
                            <g:select class="field ui-widget-content ui-corner-all" name="unidad"
                    ...
                    <tr class="prop ${hasErrors(bean: entidadesProyectoInstance, field: 'tipoParticipacion', 'error')}">
                        ...
                        <td class="campo" valign="middle">
                            ...
                            <g:select class="field ui-widget-content ui-corner-all"
                                      ...
                                      from="${mies.TipoParticipacion.list()}"
                    ...
                    <tr class="prop ${hasErrors(bean: entidadesProyectoInstance, field: 'rol', 'error')}">
                        ...
                        <td class="campo" valign="middle">
                            <g:textArea class="field ui-widget-content ui-corner-all" minLenght="1"
                                        ...
                                        title="Rol que desempeñan" style="resize: none"/>
                        </td>
                    </tr>
                    </tbody>
                </table>
...
<div id="confirmar" title="Eliminar">
    <p>
        <span class="ui-icon ui-icon-alert" style="float:left; margin:0 7px 20px 0;"></span>
        ¿Eliminar las entidades del proyecto?
    </p>
</div>
...
<script type="text/javascript">
    ...
    $("#btnSalir").click(function () {
        location.href='${createLink(controller: 'proyecto', action: 'show')}/' + '${proyecto?.id}'
    });
    ...
    $(function() {
        ...
        $("#dlg_nuevo${abr}").dialog({
            ...
            buttons: {
                ...
                "Guardar": function() {
                    ...
                    $.ajax({
                        type: "POST",
                        url: '${createLink(controller: 'proyecto', action: 'saveEntidades')}',
                        data: data,
                        success: function(msg) {
                            ...
                            if (parts[0] == "OK") {
                                ...
                                if(parts[0] == 'no1'){
                                    $("#spanError").text("Ha ocurrido un error al guardar la entidad del proyecto");
                                    $("#divError").show();
                                }else{
        ...
        $(".delete").button("option", "icons", {primary:'ui-icon-trash'}).click(function() {
            ...
            if (del.length > 0) {
                ...
                %{--var url = "${createLink(controller: 'proyecto', action:'borrarEntidad')}";--}%
