                ...
                %{--</div>--}%
                    ...
                    <tr class="prop ${hasErrors(bean: documentoInstance, field: 'proyecto', 'error')}">
                        ...
                        <td class="campo" valign="middle">
                            <g:select class="field ui-widget-content ui-corner-all" name="proyecto.id" title="${Documento.constraints.proyecto.attributes.mensaje}" from="${mies.Proyecto.list()}" optionKey="id" value="${documentoInstance?.proyecto?.id}" noSelection="['null': '']" />
                            %{----}%
                        </td>
                        ...
                        <td class="campo" valign="middle">
                            <g:select class="field ui-widget-content ui-corner-all" name="grupoProcesos.id" title="${Documento.constraints.grupoProcesos.attributes.mensaje}" from="${mies.GrupoProcesos.list()}" optionKey="id" value="${documentoInstance?.grupoProcesos?.id}" noSelection="['null': '']" />
                            %{----}%
                        </td>
