...
<div style="margin-left: 10px;">
    <div class="hoja">
        <div class="titulo">Modificaciones al POA de la unidad: <br/>${unidad}</div>
            ...
            <table width="600px;" style="margin-top: 20px;font-size: 10px">
                ...
                <tr class="odd">
                    ...
                    <td class="programa" style="width: 250px;">
                        ${(mod.desde.marcoLogico)?mod.desde.marcoLogico.proyecto.programaPresupuestario.descripcion:mod.desde.programaPresupuestario.descripcion}
                    </td>
                ...
                <tr class="even">
                    ...
                    <g:if test="${mod.recibe}">
                        ...
                        <td class="programa">
                            ${(mod.recibe.marcoLogico)?mod.recibe.marcoLogico.proyecto.programaPresupuestario.descripcion:mod.recibe.programaPresupuestario.descripcion}
                        </td>
