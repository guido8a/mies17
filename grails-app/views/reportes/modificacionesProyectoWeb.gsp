            ...
            <g:each in="${mods}" var="mod" status="i">
                <fieldset>
                    ...
                    <table style="width: 95%;">
                        ...
                        <tbody>
                            <g:set var="indis" value="${mies.Indicador.findAllByModificacion(mod,[sort:'id'])}"></g:set>
                            <g:set var="sups" value="${mies.Supuesto.findAllByModificacion(mod,[sort:'id'])}"></g:set>
                            <g:set var="medios"
                                   value="${mies.MedioVerificacion.findAllByModificacion(mod,[sort:'id'])}"></g:set>
                            <g:set var="mdcb"
                                   value="${mies.Modificables.findAllByModificacion(mod,[sort:'id'])}"></g:set>
                            <g:each in="${mdcb}" var="md">
                                <tr>
                                    <g:if test="${md.tipo==1}">
                                        <td><b>Fin</b></td>
                                        <g:set var="org" value="${mies.MarcoLogico.get(md.id_remoto.toLong())}"></g:set>
                                        <td>${org.objeto}</td>
                                        <td>${mies.MarcoLogico.findByPadreMod(org).objeto}</td>
                                    </g:if>
                                    <g:if test="${md.tipo==2}">
                                        <td><b>Proposito</b></td>
                                        <g:set var="org" value="${mies.MarcoLogico.get(md.id_remoto.toLong())}"></g:set>
                                    ...
                                    <g:if test="${md.tipo==3}">
                                        <td>Indicador</td>
                                        <g:set var="org" value="${mies.Indicador.get(md.id_remoto.toLong())}"></g:set>
                                    ...
                                    <g:if test="${md.tipo==5}">
                                        <td>Supuesto</td>
                                        <g:set var="org" value="${mies.Supuesto.get(md.id_remoto.toLong())}"></g:set>
                                        <td>${org.descripcion}</td>
                                    ...
                                    <g:if test="${md.tipo==7}">
                                        ...
                                        <g:set var="org"
                                               value="${mies.MedioVerificacion.get(md.id_remoto.toLong())}"></g:set>
                                        <td>${org.descripcion}</td>
