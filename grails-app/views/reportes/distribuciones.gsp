...
<div class="hoja" style="font-size: 12px">
    ...
    <g:each in="${asgs}" var="asg" status="i">
        ...
        <g:set var="dist" value="${mies.DistribucionAsignacion.findAllByAsignacion(asg)}"></g:set>
        <g:if test="${dist}">
            <fieldset style="margin-top: 5px;font-size: 12px;">
                ...
                <table style="margin-bottom: 15px;font-size: 12px;">
                    <g:each in="${dist}" var="d">
                        ...
                        <g:each in="${mies.Asignacion.findAllByPadreAndUnidadNotEqual(asg,unidad)}" var="hija">
                            <g:set var="mods" value="${mies.ModificacionAsignacion.findAllByDesdeOrRecibe(hija,hija)}"></g:set>
                            ...
                            <g:each in="${mies.Asignacion.findAllByPadreAndUnidadNotEqual(hija,unidad)}" var="hija2">
                                <g:set var="mods2" value="${mies.ModificacionAsignacion.findAllByDesdeOrRecibe(hija2,hija2)}"></g:set>
                                <tr style="${(mods)?'background: #eabcb6':'background: #F5F5F5'}">
                                    <td>${hija2.id}</td>
                                    <td>${hija2.unidad}</td>
                                ...
                                <g:each in="${mies.Asignacion.findAllByPadreAndUnidadNotEqual(hija2,unidad)}" var="hija3">
                                    <g:set var="mods3" value="${mies.ModificacionAsignacion.findAllByDesdeOrRecibe(hija3,hija3)}"></g:set>
                                    <tr style="${(mods)?'background: #eabcb6':'background: #F5F5F5'}">
                                        <td>${hija3.id}</td>
                                        <td>${hija3.unidad}</td>
