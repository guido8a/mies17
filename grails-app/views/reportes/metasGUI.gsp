        ...
        <div class="body">
            <div class="dialog">
                ...
                <fieldset class="ui-corner-all" style="width: 1010px;height: 55px;">
                    ...
                    <b>Indicador:</b>
                    <g:select class="ui-corner-all" from="${mies.TipoMeta.list()}" optionKey="id" optionValue="descripcion" name="tipo" id="indicador" style="width: 110px;" noSelection="['-1': 'Todos']"/> &nbsp;&nbsp;
